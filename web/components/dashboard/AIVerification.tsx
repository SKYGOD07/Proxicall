...
export default function AIVerification() {
    const aiActions = [
        { id: 1, to: "Mom", trigger: "Missed Call", context: "In a meeting", response: "Hey Mom, I can't pick up right now. In a meeting, will call back soon!", verified: true, flagged: false },
        { id: 2, to: "Boss", trigger: "Whisper Command", context: "Tell him I'm driving", response: "Hello sir, checking in. I am currently driving and cannot answer securely. I will return your call when stationary.", verified: true, flagged: false },
        { id: 3, to: "Unknown", trigger: "Auto-Filter", context: "Spam likely", response: "Use text-screen protocol.", verified: false, flagged: true },
    ];
